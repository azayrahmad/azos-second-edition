...
function ShowRunDialog() {
  ...
  textEl.textContent = 'Type the name of a program, folder, document, or Internet resource, and Windows will open it for you.';
  ...
  const executeCommand = () => {
    ...
    const app = apps.find(app => app.id.toLowerCase() === command.toLowerCase());
    if (app) {
        launchApp(app.id);
        win.close();
        return;
