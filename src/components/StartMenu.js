...
class StartMenu {
  ...
  attachSubmenu(menuItem, submenuItems) {
    ...
    const openMenu = () => {
      ...
      const startupFolderItem = submenuItems.find(item => item.id === 'startup-folder');
      if (startupFolderItem) {
        startupFolderItem.submenu = this._getStartupSubmenuItems();
      }
