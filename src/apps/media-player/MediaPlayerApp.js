...
export class MediaPlayerApp extends Application {
        ...
        container.innerHTML = `
            ...
            <div class="media-controls">
                ...
                <div class="control-buttons">
                    <button class="control-button play-pause" title="Play"></button>
                    <button class="control-button stop" title="Stop"></button>
                    <div class="separator"></div>
                    <button class="control-button seek-backward" title="Seek Backward"></button>
                    <button class="control-button fast-rewind" title="Rewind"></button>
                    <button class="control-button fast-forward" title="Fast Forward"></button>
                    <button class="control-button seek-forward" title="Seek Forward"></button>
                    <div class="separator"></div>
                    <div class="volume-control">
                        <button class="control-button mute" title="Mute"></button>
    ...
    _onLaunch() {
        ...
        this.mediaElement.addEventListener('timeupdate', () => {
            const percentage = (this.mediaElement.currentTime / this.mediaElement.duration) * 100;
