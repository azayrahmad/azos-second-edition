...
window.jspaint['view-zoom-normal'] = () => set_magnification(1);
window.jspaint['view-zoom-large'] = () => set_magnification(4);
window.jspaint['view-zoom-custom'] = show_custom_zoom_window;
...
window.jspaint['file-new'] = file_new;
function file_new() {
	are_you_sure(() => {
		deselect();
		cancel();
...
window.jspaint['file-open'] = file_open;
...
window.jspaint['file-save'] = file_save;
...
window.jspaint['file-save-as'] = file_save_as;
...
window.jspaint['help-about-paint'] = show_about_paint;
...
window.jspaint['edit-repeat'] = redo;
function redo() {
	if (redos.length < 1) {
...
window.jspaint['edit-history'] = show_document_history;
 ...
 */
window.jspaint['edit-clear-selection'] = delete_selection;
...
window.jspaint['edit-select-all'] = select_all;
window.jspaint['view-tool-box'] = () => $toolbox.toggle();
window.jspaint['view-color-box'] = () => $colorbox.toggle();
window.jspaint['view-status-bar'] = () => $status_area.toggle();
function select_all() {
	deselect();
	select_tool(get_tool_by_id(TOOL_SELECT));
 ...
 */
window.jspaint['edit-copy'] = edit_copy;
 ...
 * @param {boolean} [execCommandFallback]
 */
window.jspaint['edit-cut'] = edit_cut;
 ...
 * @param {boolean} [execCommandFallback]
 */
window.jspaint['edit-paste'] = edit_paste;
...
window.jspaint['image-invert-colors'] = image_invert_colors;
...
window.jspaint['image-clear-image'] = clear;
function clear() {
	deselect();
	cancel();
	undoable({
...
window.jspaint['view-view-bitmap'] = view_bitmap;
...
window.jspaint['image-attributes'] = image_attributes;
...
window.jspaint['image-flip-rotate'] = image_flip_and_rotate;
...
window.jspaint['image-stretch-skew'] = image_stretch_and_skew;
