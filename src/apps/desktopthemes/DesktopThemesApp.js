...
export class DesktopThemesApp extends Application {
  ...
  _createWindow() {
    ...
    themeLabel.innerHTML = "<u>T</u>heme:";
    ...
    settingsFieldset.innerHTML = `
      ...
      <div class="field-row">
        ...
        <label for="cb-screensaver">Screen <u>s</u>aver</label>
      </div>
      <div class="field-row">
        <input type="checkbox" id="cb-sound" checked disabled />
        <label for="cb-sound"><u>S</u>ound events</label>
      </div>
      <div class="field-row">
        <input type="checkbox" id="cb-mouse" checked disabled />
        <label for="cb-mouse"><u>M</u>ouse pointers</label>
      </div>
      <div class="field-row">
        <input type="checkbox" id="cb-wallpaper" checked disabled />
        <label for="cb-wallpaper">Desktop <u>w</u>allpaper</label>
      </div>
      <div class="field-row">
        <input type="checkbox" id="cb-icons" checked disabled />
        <label for="cb-icons"><u>I</u>cons</label>
      </div>
      <div class="field-row">
        <input type="checkbox" id="cb-colors" checked disabled />
        <label for="cb-colors"><u>C</u>olors</label>
      </div>
      <div class="field-row">
        <input type="checkbox" id="cb-fontnames" checked disabled />
        <label for="cb-fontnames"><u>F</u>ont names and styles</label>
      </div>
      <div class="field-row">
        <input type="checkbox" id="cb-fontsizes" checked disabled />
        <label for="cb-fontsizes">Font and window si<u>z</u>es</label>
      </div>
    `;
