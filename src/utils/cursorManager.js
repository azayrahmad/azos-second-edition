...
function createCursorTheme(themeName, cursorSet) {
  return {
    ...
    '--cursor-nesw-resize': { value: `url(${cursorSet.sizeNESW}), nesw-resize` },
    '--cursor-ns-resize': { value: `url(${cursorSet.sizeNS}), ns-resize` },
    '--cursor-nwse-resize': { value: `url(${cursorSet.sizeNWSE}), nwse-resize` },
    '--cursor-we-resize': { value: `url(${cursorSet.sizeWE}), ew-resize` },
  };
}

const cursorThemes = {
  'dangerous-creatures': createCursorTheme('dangerous-creatures', cursors.dangerousCreatures),
